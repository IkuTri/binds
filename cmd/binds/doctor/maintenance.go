...
func CheckStaleClosedIssues(path string) DoctorCheck {
	...
	return DoctorCheck{
		...
		Fix:      "Run 'binds doctor --fix' to cleanup, or 'binds admin cleanup --force' for more options",
		Category: CategoryMaintenance,
	}
}
...
func CheckExpiredTombstones(path string) DoctorCheck {
	...
	return DoctorCheck{
		...
		Fix:      "Run 'binds doctor --fix' to prune, or 'binds admin cleanup --force' for more options",
		Category: CategoryMaintenance,
	}
}
...
func CheckStaleMolecules(path string) DoctorCheck {
	...
	return DoctorCheck{
		...
		Detail:   detail,
		Fix:      "Run 'binds mol stale' to review, then 'binds close <id>' for each",
		Category: CategoryMaintenance,
	}
}
...
func CheckCompactionCandidates(path string) DoctorCheck {
	...
	return DoctorCheck{
		...
		Fix:      "Run 'binds compact --analyze' to review candidates",
		Category: CategoryMaintenance,
	}
}
...
func CheckPersistentMolIssues(path string) DoctorCheck {
	...
	return DoctorCheck{
		...
		Detail:   detail,
		Fix:      "Run 'binds delete <id> --force' to remove, or use 'binds mol wisp' instead of 'binds mol pour'",
		Category: CategoryMaintenance,
	}
}
...
func CheckPatrolPollution(path string) DoctorCheck {
	...
	return DoctorCheck{
		...
		Fix:      "Run 'binds doctor --fix' to clean up patrol pollution",
		Category: CategoryMaintenance,
	}
}
