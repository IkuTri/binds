...
var cleanupAliasCmd = &cobra.Command{
	Use:        "cleanup",
	Hidden:     true,
	Deprecated: "use 'binds admin cleanup' instead (will be removed in v1.0.0)",
	Short:      "Alias for 'binds admin cleanup' (deprecated)",
...
var compactAliasCmd = &cobra.Command{
	Use:        "compact",
	Hidden:     true,
	Deprecated: "use 'binds admin compact' instead (will be removed in v1.0.0)",
	Short:      "Alias for 'binds admin compact' (deprecated)",
...
var resetAliasCmd = &cobra.Command{
	Use:        "reset",
	Hidden:     true,
	Deprecated: "use 'binds admin reset' instead (will be removed in v1.0.0)",
	Short:      "Alias for 'binds admin reset' (deprecated)",
	Long:       resetCmd.Long,
	Run: func(cmd *cobra.Command, args []string) {
