...
func warnWorktreeDaemon(dbPathForWarning string) {
	...
	fmt.Fprintln(os.Stderr, "╠══════════════════════════════════════════════════════════════════════════╣")
	fmt.Fprintln(os.Stderr, "║ Git worktrees share the same .binds directory, which can cause the      ║")
	...
	fmt.Fprintln(os.Stderr, "║   1. Configure sync-branch:   binds config set sync-branch beads-metadata  ║")
	fmt.Fprintln(os.Stderr, "║   2. Use --no-daemon flag:    binds --no-daemon <command>                   ║")
	fmt.Fprintln(os.Stderr, "║   3. Disable daemon mode:     export BINDS_NO_DAEMON=1                   ║")
	fmt.Fprintln(os.Stderr, "╚══════════════════════════════════════════════════════════════════════════╝")
	fmt.Fprintln(os.Stderr)
}
...
func warnMultipleDatabases(currentDB string) {
	...
	if activeIdx == 0 {
		...
		fmt.Fprintln(os.Stderr, "║ WARNING: Not using the closest database! Check your BINDS_DB setting.   ║")
	}
	fmt.Fprintln(os.Stderr, "║                                                                          ║")
