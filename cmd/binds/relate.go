...
func init() {
	...
	relateAliasCmd.Deprecated = "use 'binds dep relate' instead (will be removed in v1.0.0)"
	rootCmd.AddCommand(&relateAliasCmd)

	unrelateAliasCmd := *unrelateCmd
	unrelateAliasCmd.Hidden = true
	unrelateAliasCmd.Deprecated = "use 'binds dep unrelate' instead (will be removed in v1.0.0)"
