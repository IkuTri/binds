...
// gateCmd is the parent command for gate sub-commands.
// Stub: gate.go was removed; gateDiscoverCmd is registered here as a top-level sub.
var gateCmd = &cobra.Command{
	Use:   "gate",
	Short: "Manage workflow gates",
}

// isNumericID returns true if s looks like a numeric ID (GitHub run ID, etc.).
