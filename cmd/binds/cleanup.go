...
// showCleanupDeprecationHint shows a hint about binds doctor --fix
func showCleanupDeprecationHint() {
	fmt.Fprintln(os.Stderr, ui.RenderMuted("💡 Tip: 'binds doctor --fix' can now cleanup stale issues and prune tombstones"))
}
...
It does NOT remove temporary files - use 'binds clean' for that.
