...
var mergeCmd = &cobra.Command{
	...
	GroupID: "sync",
	Short:   "Git merge driver for binds JSONL files",
	Long: `binds merge is a git merge driver for binds issue tracker JSONL files.

NOTE: This command is for git merge operations, NOT for merging duplicate issues.
To merge duplicate issues, use 'binds duplicates --auto-merge' instead.
