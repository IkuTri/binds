...
import (
	...
	"github.com/IkuTri/binds/internal/formula"
...
var templateCmd = &cobra.Command{
	...
	Deprecated: "use 'binds mol' instead (will be removed in v1.0.0)",
...
var templateListCmd = &cobra.Command{
	...
	Deprecated: "use 'binds formula list' instead (will be removed in v1.0.0)",
...
var templateShowCmd = &cobra.Command{
	...
	Deprecated: "use 'binds mol show' instead (will be removed in v1.0.0)",
...
var templateInstantiateCmd = &cobra.Command{
	...
	Deprecated: "use 'binds mol bond' instead (will be removed in v1.0.0)",
