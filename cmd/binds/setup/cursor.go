...
const cursorRulesTemplate = `# Binds Issue Tracking
# Auto-generated by 'binds setup cursor' - do not remove these markers
# BEGIN BINDS INTEGRATION
...
- Use ` + "`binds create`" + ` to track new issues/tasks/bugs
...
3. Do the work
4. Mark complete: ` + "`binds close <id>`" + `
