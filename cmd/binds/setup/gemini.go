...
func removeGemini(env geminiEnv, project bool) error {
	...
	removeHookCommand(hooks, "PreCompress", "binds prime")
	removeHookCommand(hooks, "SessionStart", "binds prime --stealth")
	removeHookCommand(hooks, "PreCompress", "binds prime --stealth")
...
func hasGeminiBeadsHooks(settingsPath string) bool {
	...
	// Check SessionStart and PreCompress for "binds prime"
