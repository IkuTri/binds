...
# Path to database (overridden by BINDS_DB or --db)
# db: ""

# Auto-start daemon if not running (can also use BINDS_AUTO_START_DAEMON)
...
` + "```bash" + `
# Create new issues
binds create "Add user authentication"
