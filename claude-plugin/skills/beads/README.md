...
A comprehensive skill for using [beads](https://github.com/IkuTri/binds) (bd) issue tracking with Claude Code.
...
- [bd CLI](https://github.com/IkuTri/binds) installed (`brew install beads`)
...
This skill is maintained at [github.com/IkuTri/binds](https://github.com/IkuTri/binds) in the `claude-plugin/skills/beads/` directory.
