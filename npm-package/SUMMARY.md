...
- Constructs URL: `https://github.com/IkuTri/binds/releases/download/v{VERSION}/beads_{VERSION}_{platform}_{arch}.{ext}`
...
- [beads repository](https://github.com/IkuTri/binds)
