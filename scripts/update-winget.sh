...
SHA256=$(curl -sL "https://github.com/IkuTri/binds/releases/download/v$VERSION/checksums.txt" | grep windows | awk '{print $1}')

if [ -z "$SHA256" ]; then
    echo "Error: Could not find Windows checksum for v$VERSION"
    echo "Make sure the release exists: https://github.com/IkuTri/binds/releases/tag/v$VERSION"
    exit 1
fi
...
cat > "$WINGET_DIR/IkuTri.binds.yaml" << EOF
# yaml-language-server: \$schema=https://aka.ms/winget-manifest.version.1.6.0.schema.json
PackageIdentifier: IkuTri.binds
...
cat > "$WINGET_DIR/IkuTri.binds.installer.yaml" << EOF
...
Installers:
  - Architecture: x64
    InstallerUrl: https://github.com/IkuTri/binds/releases/download/v$VERSION/beads_${VERSION}_windows_amd64.zip
...
cat > "$WINGET_DIR/IkuTri.binds.locale.en-US.yaml" << EOF
# yaml-language-server: \$schema=https://aka.ms/winget-manifest.defaultLocale.1.6.0.schema.json
PackageIdentifier: IkuTri.binds
PackageVersion: $VERSION
PackageLocale: en-US
Publisher: IkuTri
PublisherUrl: https://github.com/IkuTri
PublisherSupportUrl: https://github.com/IkuTri/binds/issues
Author: IkuTri
PackageName: beads
PackageUrl: https://github.com/IkuTri/binds
License: MIT
LicenseUrl: https://github.com/IkuTri/binds/blob/main/LICENSE
Copyright: Copyright (c) 2024 IkuTri
...
Tags:
  ...
  - cli
  - developer-tools
ReleaseNotesUrl: https://github.com/IkuTri/binds/releases/tag/v$VERSION
...
echo "3. Copy winget/*.yaml to manifests/s/IkuTri.binds/$VERSION/"
